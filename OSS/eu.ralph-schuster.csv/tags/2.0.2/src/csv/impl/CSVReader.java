...
public class CSVReader extends AbstractTableReader {
	 ...
	 * @see csv.impl.AbstractTableReader#close()
	 */
	@Override
	public void close() {
	 ...
	 * @see csv.impl.AbstractTableReader#getReader()
	 */
	@Override
     ...
     */
    private String[] convertToColumnArray(StringBuffer s) {
    	String rc[] = null;
                ...
                case MODE_PRE_DELIM:
                    if (isSeparator(c)) {
                    	...
                    	if (!isIgnoreEmptyLines()) {
                    		s.delete(0, i+1);
                    		return new String[Math.max(0, minColumnCount)];
                    	} 
     ...
     */
    protected String[] createArray(List<String> columns) {
