...
public class ExcelReader extends AbstractTableReader {
	...
	/**
	 * @param minimumColumnCount the minimumColumnCount to set
	 */
	public void setMinimumColumnCount(int minimumColumnCount) {
	...
	public Object[] getValues(Row row) {
        ...
        Object rc[] = new Object[Math.max(colcount, minimumColumnCount)];
		return columns.toArray(rc);
	}
