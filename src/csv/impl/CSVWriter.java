...
public class CSVWriter extends AbstractTableWriter {
	 ...
	 * @see csv.impl.AbstractTableWriter#getWriter()
	 */
	@Override
    ...
    public void printRow(Object[] columns) throws IOException {
        ...
        for (i=0; i<columns.length; i++) {
            ...
            if (i != 0) getWriter().print(getColumnSeparator());
            if (o != null) getWriter().print(prepareColumn(o.toString(), i));
            
        }
        if (columnCount < columns.length) columnCount = columns.length;
        getWriter().print(rowSeparator);
        getWriter().flush();
        rowCount++;
    }
    ...
    public void printComment(String comment) throws IOException {
    	getWriter().print(getCommentChar()+' '+comment);
    	getWriter().print(rowSeparator);
    	getWriter().flush();
    }
	...
	/**
	 * Returns the rows written to the stream.
	 * @return the rowCount
	 */
