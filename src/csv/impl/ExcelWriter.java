...
public class ExcelWriter extends AbstractTableWriter {
	 ...
	 * will call {@link DefaultExcelFormatter#INSTANCE} if no formatter was set.
	 * @param cell cell to be formatted
	 * @param value value that was  set
	 * @see #setValue(Cell, Object)
	 */
	protected void setStyle(Cell cell, Object value) {
		if (formatter != null) formatter.setStyle(this, cell, value);
		else DefaultExcelFormatter.INSTANCE.setStyle(this, cell, value);
	}
}
